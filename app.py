...
def add_member():
    ...
    try:
        cursor.excute("INSERT INTO Members (name, email, phone) VALUES (%s, %s, %s)", (name, email, phone))
        connection.commit()
...
def update_member(id):
    ...
    try:
        cursor.excute("UPDATE Members SET name = %s, email = %s, phone =%s", (name, email, phone, id))
        connection.commit()
...
def delete_member(id):
    ...
    try:
        cursor.excute("DELETE FROM Member WHERE id = %s", (id))
        connection.commit()
...
def schedule_workout():
    ...
    try:
        cursor.excute("INSERT INTO WorkoutSessions (member_id, date, duration, type)  VALUES (%S, %S, %S)", (member_id, date, duration, workout_type))
        connection.commit()
...
def get_workouts_for_member(member_id):
    ...
    try:
       cursor.excute("SELECT * FROM WorkoutSessions WHERE member_id = %s", (member_id,))
...
def update_workout(id):
    ...
    try:
        cursor.excute("UPDATE WorkoutSessions SET date = %s, duration = $s, type = WHERE id = %s", (date, duration, workout_type, id))
        connection.commit()
...
def delete_workout(id):
    ...
    try:
        cursor.excute("DELETE FROM  WorkoutSessions WHERE id = %s", (id,))
        connection.commit()
